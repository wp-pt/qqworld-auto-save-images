					...
					<tbody>
						<tr valign="top">
							...
							<td>
								...
								<p>
									<a href="https://www.qqworld.org/product/qqworld-collector" target="_blank" class="button button-primary"><?php _e('Details or Purchase', $this->text_domain); ?> &#8667;</a>
								</p>
							</td>
						</tr>
						<tr valign="top">
		...
		<table id="contact-list" class="form-table">
			<tbody>
				...
				<tr>
					...
					<td><img src="<?php echo QQWORLD_AUTO_SAVE_IMAGES_URL; ?>images/qrcode/wechat-follow.png" class="qr-code" />
